...
export default function Semua() {
  ...
  return (
    <div ref={smoothWrapper} className="overflow-hidden relative bg-[#FB9E3A]">
      <div ref={smoothContent} className="relative">
        ...
        bg-[#FB9E3A] text-white leading-none z-10 -mt-2"
        >
          <h2
            ref={title1section}
            className="absolute inset-0 flex items-center justify-center z-10 font-funnel text-5xl text-white font-bold text-center"
          >
            Cerita dari Negeri Istana
          </h2>
          ...
          <div className="cards-wrapper absolute inset-0 flex items-end justify-center pointer-events-none z-10">
            {[1, 2, 3, 4, 5].map((i) => (
              <div
                key={i}
                className="card w-[250px] h-[350px] shadow-lg rounded-sm absolute overflow-hidden flex items-center justify-center"
              >
                <img
          ...
          <div className="image-transition absolute inset-0 flex items-center justify-center z-0 p-20">
            {/* <img
            ...
            <div className="inside-wrapper absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none mx-52">
              <div className="inside-content opacity-0">
                <h1 className="font-funnel text-5xl text-white text-center">
